...
public final class ConsumerServiceImpl implements ConsumerService {
    ...
    private static Properties properties() {
        ...
        properties.setProperty(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "10.106.240.240:9092");
        properties.setProperty(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getName());
        properties.setProperty(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getName());
        properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "consumer-hooks-pagamentos-group");
        return properties;
    }
